...
export default function ItemCard({
  ...
  return (
    <div
      className="bg-white p-4 rounded-2xl shadow-md hover:shadow-lg transition-all duration-500 ease-in-out animate-fadeIn flex flex-col h-full relative"
    >
      {/* Image */}
      {item.image_url && (
        <>
      ...
      <div className="flex-1 border border-gray-200 rounded-lg p-4 bg-gray-50 space-y-4 mt-1">
        ...
        <div className="-mt-2 border border-gray-400 p-5 rounded-lg bg-yellow-200">
          <p className="-mt-3 text-xs font-semibold text-gray-700 mb-1">
            Description:
          </p>
