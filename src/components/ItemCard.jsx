...
export default function ItemCard({ item, onDelete, onImageClick, isOwner, onToggleReturned }) {
  const [isLoading, setLoading] = useState(true);

  return (
    <motion.div
      className="bg-white p-4 rounded-2xl shadow-md flex flex-col h-full relative"
    ...
    >
      ...
      {/* Title */}
      <h3 className="border border-gray-300 rounded-2xl text-lg font-semibold text-center text-black inline-block py-2 px-4 bg-gradient-to-r from-blue-100 to-blue-200 shadow-md mb-3">
        {item.title}
      </h3>
